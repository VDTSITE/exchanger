							...
							<div class="content">
								<table class="regular-table">
									...
									<tr>
										...
										<td class="actions">
											<a href="edit_portfolio_categories.php?idc={$categories[i].id}"><i class="fa fa-file-text-o" title="Редактировать"></i></a>
											<a href="delete_portfolio_categories.php?idc={$categories[i].id}&categorie={$categories[i].name}"><i class="fa fa-trash-o" title="Удалить"></i></a>
										</td>
