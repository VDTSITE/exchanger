									...
									<table class="regular-table">
										...
										<tr {if $currency[i].act == 1}style="background: rgba(210, 210, 210, 0.8) none repeat scroll 0% 0%; text-decoration: line-through; color: rgb(136, 136, 136);"{/if}>
											...
											<td class="actions">
												...
												<a href="{if $currency[i].act == 0}currency_wm.php?act_currency=1&ida={$currency[i].id}{else}currency_wm.php?act_currency=0&ida={$currency[i].id}{/if}">{if $currency[i].act == 0}Скрыть{else}Показать{/if}</a>
											</td>
											<td class="actions">
												<!-- <a href="#"><i class="fa fa-file-text-o"></i></a> -->
												<a href="delete_currency_wm.php?idc={$currency[i].id}"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
