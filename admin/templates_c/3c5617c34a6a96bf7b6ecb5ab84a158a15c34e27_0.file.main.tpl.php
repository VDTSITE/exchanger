<?php /* Smarty version 3.1.25, created on 2016-05-07 14:53:14
         compiled from "/home/vdtvdt/vdt.site/print/admin/templates/main.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:1713794532572dd72a9bbe19_84285380%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c5617c34a6a96bf7b6ecb5ab84a158a15c34e27' => 
    array (
      0 => '/home/vdtvdt/vdt.site/print/admin/templates/main.tpl',
      1 => 1462621993,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1713794532572dd72a9bbe19_84285380',
  'variables' => 
  array (
    'user_photo' => 0,
    'user_name' => 0,
  ...
  'version' => '3.1.25',
  'unifunc' => 'content_572dd72a9e0f03_27579366',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_572dd72a9e0f03_27579366')) {
function content_572dd72a9e0f03_27579366 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '1713794532572dd72a9bbe19_84285380';
?>
<!doctype html>
...
<body class="no-margin-top">
	...
	<div class="sidebar sidebar-left">
		...
		<div class="logo-container">
			<a href="http://vdt.site/" target="_blank"><h1>Принтер</h1></a>
		</div>
		<!-- Logo End -->
...
, добро пожаловать!</span>
		...
		<ul class="active main-menu">
			...
			<li class="">
				<a href="view_desc.php"><i class="fa fa-text-width"></i><span> Описание</span></a>
			...
			<li class="has-submenu">
				<a href=""><i class="fa fa-map-marker"></i><span> Где купить</span></a>
				<ul class="submenu">
					<li><a href="view_buy.php">Просмотр мест</a></li>
					<li><a href="add_buy.php">Добавление места</a></li>
					<!-- <li><a href="video_report.php">Видеоотчет</a></li>
					<li><a href="view_contact.php">Обратная связь</a></li> -->
				</ul>
			</li>
			<li class="has-submenu">
				<a href=""><i class="fa fa-map-marker"></i><span> Где арендовать</span></a>
				<ul class="submenu">
					<li><a href="view_rent.php">Просмотр мест</a></li>
					<li><a href="add_rent.php">Добавление места</a></li>
					<!-- <li><a href="video_report.php">Видеоотчет</a></li>
					<li><a href="view_contact.php">Обратная связь</a></li> -->
				</ul>
			</li>
			...
			<li class="has-submenu">
				...
				<ul class="submenu">
					<li>
						<a href="view_slider.php">Просмотр слайдов</a>
					</li>
					<li>
						<a href="add_slider.php">Добавление слайда</a>
					</li>
					<!-- <li>
						<a href="index-white-skin.html">Белый дизайн</a>
					</li>
			...
			<li class="has-submenu">
				<a href=""><i class="fa fa-picture-o"></i><span> Слайды для ногтей</span></a>
				<ul class="submenu">
					...
					<li><a href="view_nails_slider.php">Просмотр слайдов</a></li>
					<li><a href="add_nails_slider.php">Добавление слайда</a></li>
				</ul>
			</li>
