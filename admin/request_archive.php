...
/////////////////////////////
	...
	if(isset($_POST[$elem_in])) {
		if($_POST[$elem_in] == 3) {
			$query_status_in = "update form_in set status2=3 where id=".$_POST['id_in'];
		}
		else {
			$query_status_in = "update form_in set status2=2 where id=".$_POST['id_in'];
		}
...
/////////////////////////////
	...
	if(isset($_POST[$elem_out])) {
		if($_POST[$elem_out] == 3) {
			$query_status_out = "update form_out set status2=3 where id=".$_POST['id_out'];
		}

		else {
			$query_status_out = "update form_out set status2=2 where id=".$_POST['id_out'];
		}
...
////////////////////////
	...
	if(isset($_POST[$elem_stock])) {
		if($_POST[$elem_stock] == 3) {
			$query_status_stock = "update form_stock set status2=3 where id=".$_POST['id_stock'];
		}

		else {
			$query_status_stock = "update form_stock set status2=2 where id=".$_POST['id_stock'];
		}
...
$query_mail = "select id, tel, last_name, first_name, data, status, status2 from form_in where status = 1 order by data desc";
/*echo $query_mail;*/
...
$query_mail1 = "select id, tel, last_name, first_name, data, status, status2 from form_out where status = 1 order by data desc";
/*echo $query_mail;*/
...
$query_mail2 = "select id, tel, last_name, first_name, data, status, status2 from form_stock where status = 1 order by data desc";
/*echo $query_mail;*/
