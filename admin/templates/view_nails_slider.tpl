							...
							<div class="content">
								<table class="regular-table">
									...
									<tr>
										...
										<td>
											<p>
												<img src="../images/{$mail[i].photo}" alt="" style="width: 50px;">
											</p>
										</td>
																								
										<td class="actions">
											<a href="edit_nails_slider.php?idc={$mail[i].id}"><i class="fa fa-file-text-o"></i></a>
										</td>
										<td class="actions">
											<a href="delete_nails_slider.php?idc={$mail[i].id}"><i class="fa fa-trash-o"></i></a>
										</td>
									</tr>
									{/section}
									<!-- Table Row End -->
